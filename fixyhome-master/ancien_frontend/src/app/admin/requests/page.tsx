  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-64">
        <main className="p-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Demandes de service</h1>
            <p className="text-gray-600 mt-2">Gérez les demandes de service des clients</p>
          </div>
          
          <ServiceRequestManagementFixed token={localStorage.getItem('token') || ''} />
        </main>
      </div>
    </div>
  );
