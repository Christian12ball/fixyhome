              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{getCategoryText(review.intervention.category)}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{getCategoryText(selectedReview.intervention.category)}</p>
                  </div>
                  <div>
